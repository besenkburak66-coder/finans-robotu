...
# Google Gemini API Anahtarın ve Güncel URL adresi
API_KEY = "AQ.Ab8RN6LB40mR4CRDxy3CyNqaJho1kdbuTuSARwfUOfmuGGbrAQ"
...
def seeking_alpha_toplu_veri_cek(hisse_listesi):
    ...
    for hisse in hisse_listesi:
        ...
        # Güvenlik duvarına takılmamak için şirketler arasında 1 saniye bekliyoruz
        time.sleep(1)
...
if __name__ == "__main__":
    # Senin takip listendeki şirketler
